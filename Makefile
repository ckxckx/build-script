...
install: all-release stamps/libs2e-release-install
	#ckx: repeated compile lead to overwhelming...
	# stamps/tools-release-install \
...
# ckx: repeat compile will lead to fault!!!
# $(LUA_DIR): $(LUA_SRC)
# 	tar -zxf $(LUA_SRC)
